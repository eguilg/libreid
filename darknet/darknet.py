...
from .util import predict_transform, predict_transform_half
...
class Darknet(nn.Module):
    def __init__(self, cfgfile, is_half = False):
    ...
    def forward(self, x, CUDA):
        ...
        for i in range(len(modules)):        
            ...
            if module_type == "convolutional" or module_type == "upsample" or module_type == "maxpool":
                ...
                if self.is_half:
                    x = predict_transform_half(x, inp_dim, anchors, num_classes, CUDA)
                if type(x) == int:
                    continue
